        ...
        <div className=" w-fit items-center m-auto h-auto justify-center pt-[114px] max-w-[1600px] ">
          <div className="items-center flex justify-center">
            <div className="pl-[80px]">
              <div className="text-[15px] not-italic leading-[1.2] text-[#9D9AF8] font-bold font-[Montserrat]">
                DO MORE WITH DATA. DRIVE GROWTH. SCALE.
              </div>
              <div>
                <div className="flex gap-2 w-auto">
                  <div className="text-[#002F2B] font-semibold not-italic font-[Space Grotesk] text-[40px]">
                    A unified platform for 
                  </div>
                  <div className="text-[#B0B8B1] not-italic text-[40px] font-[Space Grotesk] font-bold items-center">
                    Smart Manufacturing
                  </div>
                </div>
                <div className="text-[#032125] w-full max-w-[600px] leading-[30px] mt-5">
          ...
          <div className=" w-fit pt-10 m-auto justify-center items-center">
            <span className="w-full justify-center items-center" style={{fontSize: "40px", color: "#002F2B"}}>
              Trusted by companies worldwide who want to do more with data.
            </span>
          </div>
        </div>  
      </div>
